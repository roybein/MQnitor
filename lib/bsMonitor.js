...
newPlan = new Plan("dummy_index", "dummy_name", "dummy_relay_index", "dummy_plan_value", []);
newPlan.addJudgeElem(judgeElem1);
newJudgeElem = new JudgeElem("dummy_index", "dummy_sensorIndex", 0, 0, true, "ori");
