...
var sensorLight = {_id:"AI1", direction:"input", type:"adc", name:"light", unit:"lux", value:777, description:"a light sensor", planIdGroup:[], lock:"unlocked"};
...
var sensorTime = {_id:"time", direction:"input", type:"time", name:"localTime", time:"8:00 AM", weekday:"5", planIdGroup:[], lock:"unlocked"};
contactAll.addContact(sensorTime);

var relayMasterPower = {_id:"DO1", direction:"output", type:"relay", name:"master power", value:"on", description:"switch master power", planId:null, planSwitch:"disable"};
contactAll.addContact(relayMasterPower);

var pwmLight = {_id:"DO2", direction:"output", type:"pwm", name:"pwm light", value:"on", freq:"100Hz", duty:"50%", description:"switch master power", planId:null, planSwitch:"enable"};
