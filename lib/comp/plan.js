...
PlanBase.prototype.attachPlan = function(outputIndex, planIndex) {
    console.log("attach plan: ", planIndex, " to output: ", outputIndex);
    contactAll.collec.update({_id:outputIndex}, {$set:{planId:planIndex}});
...
PlanBase.prototype.dettachPlan = function(planIndex) {
    console.log("dettach plan: ", planIndex);
